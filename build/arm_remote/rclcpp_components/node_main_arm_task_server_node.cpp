...
#define NODE_MAIN_LOGGER_NAME "arm_task_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarm_task_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<arm_remote::AgbotTaskServer>";
