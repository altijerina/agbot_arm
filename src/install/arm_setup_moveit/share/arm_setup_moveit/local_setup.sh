...
: ${AMENT_CURRENT_PREFIX:="/home/albert/ag_arm_ws/src/install/arm_setup_moveit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_setup_moveit/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_setup_moveit/environment/path.sh"
