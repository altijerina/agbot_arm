...
class AgbotTaskServer(Node):
    def __init__(self):
        super().__init__("agbot_task_server")
        self.get_logger().info("Starting the Server")
        self.action_server = ActionServer(
            self, ArmTask, "agbot_task_server", self.goalCallback
        )
...
def main(args=None):
    ...
    agbot_task_server = AgbotTaskServer()
    rclpy.spin(agbot_task_server)
